;;; metalspleen-theme.el

;; Copyright (C) 2017, Menno Finlay-Smits
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'metalspleen
        ...
        ;; Mode-line
        `(mode-line ((t (:background ,bg2
                                      :foreground ,fg2
                                      :box ,(list
                                             :line-width 4
                                             :color bg2)))))
        `(mode-line-inactive ((t (:background ,bg2
                                              :foreground ,comment
                                              :box ,(list
                                                     :line-width 4
                                                     :color bg2)))))
...
(provide-theme 'metalspleen)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; metalspleen-theme.el ends here
